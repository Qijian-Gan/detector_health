...
plot_stability(DetectorHealthAll,detectorUnique,'All Detectors')
plot_stability(DetectorHealthAll,detectorUniqueStopbar,'Stopbar Detectors')
plot_stability(DetectorHealthAll,detectorUniqueAdvanced,'Advanced Detectors')